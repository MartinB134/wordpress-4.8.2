...
<div class="row max2055">
            <div class="col-md-6 no-padding">
                <img src="images/loftfabrik-4-1024x683.jpg" class="img-responsive">
            </div>
            <div class="col-md-6 text-box text-justify">
                <p>Einige der Wände zwischen den einzelnen Büros und Abschnitten sind flexible Raumteiler – das bedeutet, dass eine gewünschte Änderung der Raumgestaltung jederzeit möglich ist und Sie die Größe der Räume individuell nach Ihren Wünschen anpassen können.</p>
            </div>
        </div>
